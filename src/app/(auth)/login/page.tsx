...
export default async function LoginPage() {
  ...
  return (
    <div className="flex flex-col p-10 md:flex-row h-screen">
      ...
      <Tabs defaultValue="login" className="flex flex-col items-center max-w-2xl">
        <TabsList className='flex w-auto'>
          <TabsTrigger value="login" className='min-w-[100px] md:min-w-[200px] '>Login</TabsTrigger>
          <TabsTrigger value="signup" className='min-w-[100px] md:min-w-[200px]'>Signup</TabsTrigger>
        </TabsList>
